...
This file captures per-session working memory — what was built, what's running, and what to pick up next time. For the complete Phase 1+2 workflow, see [`docs/product/WORKFLOW.md`](docs/product/WORKFLOW.md).
